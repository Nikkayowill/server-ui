...
// Express 5 doesn't support optional params with ?, so we define two routes
...
// Auto-deploy (GitHub webhook) routes - legacy server-wide
...
// Multi-site domain deployment routes
app.post('/link-domain-repo', requireAuth, csrfProtection, serverController.linkDomainRepo);
app.post('/deploy-domain', requireAuth, csrfProtection, serverController.deployDomain);
app.get('/domain-info/:domainId', requireAuth, serverController.getDomainInfo);
app.post('/enable-domain-auto-deploy', requireAuth, csrfProtection, serverController.enableDomainAutoDeploy);
app.post('/disable-domain-auto-deploy', requireAuth, csrfProtection, serverController.disableDomainAutoDeploy);
